...
// HW#: HW6 dgraph
// Name: Carter Rath
// File Type: dgraph.h header file
// ==================================================
...
// which will enter the given visit number for a given vertex. This is to indicate the order in which verticies were visited. Do not use a loop to look for the vertex. Convert A to slot 0, B to slot 1, etc.
  void visit(int, char);
// which returns true if a given vertex was already visited (0 means not visited so return false). Do not use a loop to look for vertex
  bool isMarked(char);
};
